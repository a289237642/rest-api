...
class CourseInfo(models.Model):
    ...
    level = models.CharField(choices=(('初级','初级'),('中级','中级'),('高级','高级')),max_length=10,verbose_name="课程难度",default='高级')
    course_category = models.CharField(choices=(('前端开发','前端开发'),('后端开发','后端开发')),verbose_name="课程类别",max_length=15,default='后端开发')
    click_num = models.IntegerField(default=0,verbose_name="访问量")
    org = models.ForeignKey(OrgInfo,verbose_name="所属机构")
    teacher = models.ForeignKey(TeacherInfo,verbose_name="所属教师")
...
class LessonInfo(models.Model):
    ...
    course = models.ForeignKey(CourseInfo,verbose_name="所属课程")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
class VideoInfo(models.Model):
    ...
    lesson = models.ForeignKey(LessonInfo,verbose_name="所属章节")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
