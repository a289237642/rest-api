# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-08-04 08:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, default='', help_text='类别编码', max_length=20, null=True, verbose_name='类别编码')),
                ('desc', models.TextField(default='', help_text='简单描述', verbose_name='简单描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, help_text='图片', null=True, upload_to='goods/goodsimages/', verbose_name='图片')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
