    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cretify', models.IntegerField(choices=[(0, '未认证'), (1, '商业公司'), (2, '个体工商户'), (3, '个人经营'), (4, '政府及非营利组织')], default=0, verbose_name='认证类型')),
                ('real_name', models.CharField(blank=True, max_length=30, null=True, verbose_name='真实姓名')),
                ('id_num', models.CharField(blank=True, max_length=18, null=True, verbose_name='身份证号')),
