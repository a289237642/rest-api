    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, max_length=200, null=True, upload_to='teacher/%y/%m', verbose_name='讲师头像')),
                ('work_year', models.IntegerField(default=3, verbose_name='工作年限')),
                ('work_company', models.CharField(blank=True, max_length=20, null=True, verbose_name='就职公司')),
                ...
                ('work_style', models.CharField(blank=True, max_length=20, null=True, verbose_name='教学特点')),
                ('click_num', models.IntegerField(default=0, verbose_name='点击数')),
                ('love_num', models.IntegerField(default=0, verbose_name='收藏数')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
