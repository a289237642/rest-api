...
// let host = 'http://shop.atguigu.com';
//新增
// let local_host = 'http://118.190.202.67:8001';
...
export const getCategory = params => {
  if('id' in params){
    return axios.get(`${local_host}/category/`+params.id+'/');
  }
  else {
    return axios.get(`${local_host}/category/`, params);
  }
};
